...
MIGRATION_MESSAGE = (
    "This legacy UVLF production entry point is disabled. Use "
    "scripts/run/run_uvlf_v2.py --config configs/uvlf/production.toml "
    "and select scientific behavior in the TOML configuration."
)
