...
def validate_mah_backend(backend: str) -> str:
    return shared.normalize_choice(backend, choices=MAH_BACKENDS, field_name="mah_backend")


def validate_tng_time_grid_mode(mode: str) -> str:
    return shared.normalize_choice(
        mode,
        choices=TNG_TIME_GRID_MODES,
        field_name="tng_time_grid_mode",
    )
...
def _read_tng_cache_file(
    ...
    shared.validate_cache_contents(
        ...
        source_identity_columns=(source_snapshot, source_subhalo_id),
        snapshot=snapshot,
        mass_unit=mass_unit,
        time_unit=time_unit,
...
def generate_tng_halo_histories(
    ...
    *,
    ...
    time_grid_mode = shared.validate_generation_parameters(
        field_prefix="tng",
        time_grid_modes=TNG_TIME_GRID_MODES,
        uniform_time_grid_mode=TNG_TIME_GRID_UNIFORM_IN_T,
        cosmology=cosmology,
        n_tracks=n_tracks,
